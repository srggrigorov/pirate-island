...
//     version 1.7.0
//     from Assets/_GameAssets/_Scripts/Inputs/InputActions.inputactions
//
...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IGunMapActions> m_GunMapActionsCallbackInterfaces = new List<IGunMapActions>();
    ...
    public struct GunMapActions
    {
        ...
        public void AddCallbacks(IGunMapActions instance)
        {
            if (instance == null || m_Wrapper.m_GunMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_GunMapActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IGunMapActions instance)
        {
            @Shot.started -= instance.OnShot;
            @Shot.performed -= instance.OnShot;
            @Shot.canceled -= instance.OnShot;
        ...
        public void RemoveCallbacks(IGunMapActions instance)
        {
            if (m_Wrapper.m_GunMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IGunMapActions instance)
        {
            foreach (var item in m_Wrapper.m_GunMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_GunMapActionsCallbackInterfaces.Clear();
